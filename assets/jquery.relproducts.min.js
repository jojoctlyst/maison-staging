...
$(document).ready(function(){
  ...
  var viewTemplate = 'ajax_recently_viewed';
  if (_parent.find('.recently_view_products-box.arrow-tab').length) viewTemplate = 'ajax_recently_viewed_homepage';
  ...
  function sliderInit(){
    var slick = $('.tt-recently-products-js.desktop');
